...
public class DialogInstructionStore implements NamedInstructionStore {

	@Override
	public Collection<NamedOperator> getNamedInstructions() {
		return Arrays.asList(

				new NamedOperator("dialog.getstr", "message::str: popup window with a a text input field") {
					@Override
				...
				new NamedOperator("dialog.getnum", "message::str: popup window with a number input field") {
					@Override
					public void execute(BlockEvaluator blockEvaluator) {
						final Obj title = blockEvaluator.pop();
				...
				new NamedOperator("dialog.alert", "message::str title::str type::sym show an alert dialog") {
					@Override
					public void execute(BlockEvaluator blockEvaluator) {
				...
				new NamedOperator("dialog.confirm", "message::str options::list title::str type::sym show an alert dialog") {
					@Override
					public void execute(BlockEvaluator blockEvaluator) {
						final Obj type_obj = blockEvaluator.pop();
						final Obj title_obj = blockEvaluator.pop();
				...
				new NamedOperator("dialog.buttons", "message::str options::list title::str type::sym: show a dialog with several option buttons") {
					@Override
					public void execute(BlockEvaluator blockEvaluator) {
						final Obj type_obj = blockEvaluator.pop();
						final Obj title_obj = blockEvaluator.pop();
				...
				new NamedOperator("dialog.dropdown", "message::str options::list title::str type::sym: show a dialog with several options as a dropdown") {
					@Override
					public void execute(BlockEvaluator blockEvaluator) {
						final Obj type_obj = blockEvaluator.pop();
						final Obj title_obj = blockEvaluator.pop();
				...
				new NamedOperator("dialog.choosefile") {
					@Override
					public void execute(BlockEvaluator blockEvaluator) {
