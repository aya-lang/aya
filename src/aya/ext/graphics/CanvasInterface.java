...
public class CanvasInterface {
	...
	// Keys
	private final long AUTOFLUSH = SymbolEncoder.encodeString("autoflush");
	private final long EXTENT = SymbolEncoder.encodeString("extent");
	private final long HEIGHT = SymbolEncoder.encodeString("height");
	private final long ANGLE = SymbolEncoder.encodeString("angle");
	private final long THETA = SymbolEncoder.encodeString("theta");
	private final long CYCLE = SymbolEncoder.encodeString("cycle");
	private final long COLOR = SymbolEncoder.encodeString("color");
	private final long WIDTH = SymbolEncoder.encodeString("width");
	private final long STYLE = SymbolEncoder.encodeString("style");
	private final long START = SymbolEncoder.encodeString("start");
	private final long SIZE = SymbolEncoder.encodeString("size");
	private final long NAME = SymbolEncoder.encodeString("name");
	private final long TYPE = SymbolEncoder.encodeString("type");
	private final long FILE = SymbolEncoder.encodeString("file");
	private final long TEXT = SymbolEncoder.encodeString("text");
	private final long FILL = SymbolEncoder.encodeString("fill");
	private final long SHOW = SymbolEncoder.encodeString("show");
	private final long JOIN = SymbolEncoder.encodeString("join");
	private final long END = SymbolEncoder.encodeString("end");
	private final long CAP = SymbolEncoder.encodeString("cap");
	private final long DH = SymbolEncoder.encodeString("dh");
	private final long DV = SymbolEncoder.encodeString("dv");
	private final long DX = SymbolEncoder.encodeString("dx");
	private final long DY = SymbolEncoder.encodeString("dy");
	private final long X1 = SymbolEncoder.encodeString("xa");
	private final long Y1 = SymbolEncoder.encodeString("ya");
	private final long X2 = SymbolEncoder.encodeString("xb");
	private final long Y2 = SymbolEncoder.encodeString("yb");
	private final long XS = SymbolEncoder.encodeString("xs");
	private final long YS = SymbolEncoder.encodeString("ys");
	private final long W = SymbolEncoder.encodeString("w");
	private final long H = SymbolEncoder.encodeString("h");
	private final long X = SymbolEncoder.encodeString("x");
	private final long Y = SymbolEncoder.encodeString("y");
