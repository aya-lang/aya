...
public class ColorInstructionStore implements NamedInstructionStore {

	@Override
	public Collection<NamedOperator> getNamedInstructions() {
		return Arrays.asList(
				new NamedOperator("color.fromstr", "color::str: convert an html valid color to an rgba dict") {
					@Override
				...
				new NamedOperator("color.name_list", "return a list of all named colors") {
					@Override
					public void execute(BlockEvaluator blockEvaluator) {
